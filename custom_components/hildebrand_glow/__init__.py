"""
Custom integration to integrate hildebrand_glow with Home Assistant.
...
https://github.com/ubwa/home-assistant-hildebrand-glow
...
async def async_setup_entry(
    ...
    # Store runtime data
    entry.runtime_data = HildebrandGlowEnergyMonitorData(
        client=client,
