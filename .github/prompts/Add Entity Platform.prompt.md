...
**Directory:** `custom_components/hildebrand_glow/[platform]/`
...
```python
"""[Platform] platform for Hildebrand Glow Energy Monitor."""
...
from .[entity_file] import HildebrandGlowEnergyMonitor[EntityName]
...
async def async_setup_entry(
    ...
    coordinator: HildebrandGlowEnergyMonitorDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            HildebrandGlowEnergyMonitor[EntityName](coordinator, entry),
...
```python
"""[Entity description] for Hildebrand Glow Energy Monitor."""
...
class HildebrandGlowEnergyMonitor[EntityName](
...
Add platform to `custom_components/hildebrand_glow/manifest.json`:
...
- [ ] Entity class inherits from both `HildebrandGlowEnergyMonitorEntity` and platform class
...
- **Base entity:** `HildebrandGlowEnergyMonitorEntity` in `entity/base.py`
- **Coordinator:** `HildebrandGlowEnergyMonitorDataUpdateCoordinator`
