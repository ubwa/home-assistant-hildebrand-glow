"""
API Client for hildebrand_glow.
...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        HildebrandGlowEnergyMonitorApiClientAuthenticationError: For 401/403 errors.
        aiohttp.ClientResponseError: For other HTTP errors.

    """
    if response.status in (401, 403):
        msg = "Invalid credentials"
        raise HildebrandGlowEnergyMonitorApiClientAuthenticationError(
            msg,
        )
...
class HildebrandGlowEnergyMonitorApiClient:
    ...
    async def _api_wrapper(
        ...
        try:
            ...
            raise HildebrandGlowEnergyMonitorApiClientCommunicationError(
                msg,
            ) from exception
            ...
            raise HildebrandGlowEnergyMonitorApiClientError(
                msg,
            ) from exception
