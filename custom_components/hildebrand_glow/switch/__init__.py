"""Switch platform for hildebrand_glow."""
...
from .example_switch import ENTITY_DESCRIPTIONS as SWITCH_DESCRIPTIONS, HildebrandGlowEnergyMonitorSwitch
...
async def async_setup_entry(
    ...
    async_add_entities(
        HildebrandGlowEnergyMonitorSwitch(
