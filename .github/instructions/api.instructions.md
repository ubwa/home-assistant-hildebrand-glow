...
- `HildebrandGlowEnergyMonitorApiClientError` (Base)
- `HildebrandGlowEnergyMonitorApiClientCommunicationError` (Network, timeout, HTTP errors)
- `HildebrandGlowEnergyMonitorApiClientAuthenticationError` (401, 403, invalid credentials)
