...
**File:** `custom_components/hildebrand_glow/services.yaml`
...
Create `custom_components/hildebrand_glow/service_actions/[action_name].py`:

```python
"""[Action name] service action for Hildebrand Glow Energy Monitor."""
...
**File:** `custom_components/hildebrand_glow/__init__.py`
...
**File:** `custom_components/hildebrand_glow/const.py`
...
3. Find service action: `hildebrand_glow.[action_name]`
...
- **Service actions directory:** `custom_components/hildebrand_glow/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/hildebrand_glow/services.yaml` (legacy filename)
- **Icons:** `custom_components/hildebrand_glow/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/hildebrand_glow/translations/*.json` under `services` key (legacy)
