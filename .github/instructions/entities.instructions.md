...
- **`entity/`** - Base entity classes (inherit `HildebrandGlowEnergyMonitorEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, HildebrandGlowEnergyMonitorEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import HildebrandGlowEnergyMonitorEntity`
