...
This document describes the technical architecture of the Hildebrand Glow Energy Monitor custom component for Home Assistant.

## Directory Structure

```text
custom_components/hildebrand_glow/
...
│   ├── __init__.py          # Exports HildebrandGlowEnergyMonitorDataUpdateCoordinator
...
│   ├── __init__.py          # Exports HildebrandGlowEnergyMonitorEntity
...
**Key class:** `HildebrandGlowEnergyMonitorDataUpdateCoordinator` (exported from `coordinator/__init__.py`)
...
**Key class:** `HildebrandGlowEnergyMonitorApiClient`
...
- `HildebrandGlowEnergyMonitorConfigFlowHandler` (main flow)
- `HildebrandGlowEnergyMonitorOptionsFlow` (options)
...
**Key class:** `HildebrandGlowEnergyMonitorEntity` (in `entity/base.py`)
...
2. `HildebrandGlowEnergyMonitorEntity` for common functionality
...
1. Create directory: `custom_components/hildebrand_glow/<platform>/`
2. Implement `__init__.py` with `async_setup_entry()`
3. Create entity classes inheriting from platform base + `HildebrandGlowEnergyMonitorEntity`
