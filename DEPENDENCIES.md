...
**Also defined in:** `custom_components/hildebrand_glow/manifest.json`
...
**Version:** Configured via `HA_VERSION` in `.devcontainer/devcontainer.json` (currently `2025.11.3`)
