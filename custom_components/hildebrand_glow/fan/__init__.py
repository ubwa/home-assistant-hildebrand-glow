"""Fan platform for hildebrand_glow."""
...
from .air_purifier_fan import ENTITY_DESCRIPTIONS as FAN_DESCRIPTIONS, HildebrandGlowEnergyMonitorFan
...
async def async_setup_entry(
    ...
    async_add_entities(
        HildebrandGlowEnergyMonitorFan(
