"""
Base entity class for hildebrand_glow.
...
from custom_components.hildebrand_glow.const import ATTRIBUTION
...
class HildebrandGlowEnergyMonitorEntity(CoordinatorEntity[HildebrandGlowEnergyMonitorDataUpdateCoordinator]):
    """
    Base entity class for hildebrand_glow.
