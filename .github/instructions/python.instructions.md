...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `HildebrandGlowEnergyMonitor`
...
- Inherit from both platform entity and `HildebrandGlowEnergyMonitorEntity` (order matters)
...
from custom_components.hildebrand_glow.sensor import async_setup_entry
...
**Config entry data:** `entry_data: HildebrandGlowEnergyMonitorData = hass.data[DOMAIN][entry.entry_id]`
