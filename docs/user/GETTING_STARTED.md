# Getting Started with Hildebrand Glow Energy Monitor

This guide will help you install and set up the Hildebrand Glow Energy Monitor custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/ubwa/home-assistant-hildebrand-glow`
6. Set category to "Integration"
7. Click "Add"
8. Find "Hildebrand Glow Energy Monitor" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/ubwa/home-assistant-hildebrand-glow/releases)
2. Extract the `hildebrand_glow` folder from the archive
3. Copy it to `custom_components/hildebrand_glow/` in your Home Assistant configuration directory
...
4. Select entities from "Hildebrand Glow Energy Monitor"
...
- Report issues at [GitHub Issues](https://github.com/ubwa/home-assistant-hildebrand-glow/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/ubwa/home-assistant-hildebrand-glow/discussions)
