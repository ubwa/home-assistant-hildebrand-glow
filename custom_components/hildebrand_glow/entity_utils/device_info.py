"""Device info utilities for hildebrand_glow."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Hildebrand Glow Energy Monitor",
        manufacturer=manufacturer or "Hildebrand Glow Energy Monitor",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('hildebrand_glow', 'entry_id_value')}
    """
