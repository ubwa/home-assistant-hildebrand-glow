...
- Inherit from `HildebrandGlowEnergyMonitorEntity` and platform base class
...
- Entity: `custom_components/hildebrand_glow/[platform]/[entity_name].py`
- Platform: `custom_components/hildebrand_glow/[platform]/__init__.py`
