# Hildebrand Glow Energy Monitor
...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/ubwa/home-assistant-hildebrand-glow?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=home-assistant-hildebrand-glow&category=integration)
...
1. Download the `custom_components/hildebrand_glow/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=hildebrand_glow)
...
3. Search for "Hildebrand Glow Energy Monitor"
...
1. Go to **Settings** → **Devices & Services**
2. Find **Hildebrand Glow Energy Monitor**
...
Find all entities in **Settings** → **Devices & Services** → **Hildebrand Glow Energy Monitor** → click on the device.
...
### `hildebrand_glow.example_action`
...
```yaml
service: hildebrand_glow.example_action
data:
  # Add your parameters here
```

### `hildebrand_glow.reload_data`
...
```yaml
service: hildebrand_glow.reload_data
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Hildebrand Glow Energy Monitor → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@ubwa][user_profile]**

---

[commits-shield]: https://img.shields.io/github/commit-activity/y/ubwa/home-assistant-hildebrand-glow.svg?style=for-the-badge
[commits]: https://github.com/ubwa/home-assistant-hildebrand-glow/commits/main
[hacs]: https://github.com/hacs/integration
[hacsbadge]: https://img.shields.io/badge/HACS-Default-orange.svg?style=for-the-badge
[license-shield]: https://img.shields.io/github/license/ubwa/home-assistant-hildebrand-glow.svg?style=for-the-badge
[maintenance-shield]: https://img.shields.io/badge/maintainer-%40ubwa-blue.svg?style=for-the-badge
[releases-shield]: https://img.shields.io/github/release/ubwa/home-assistant-hildebrand-glow.svg?style=for-the-badge
[releases]: https://github.com/ubwa/home-assistant-hildebrand-glow/releases
